  ...
  return (
    <div  className={style.footer}>
      <div className={`${style.footer_div_1}`}>
        ...
        <div className={`${style.footer_div_1_logo}`}>
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className={`${style.footer_div_2} ${style.footer_same_css}`}>
        <div className={`${style.footer_container}`}>
          <h1>PRESENTATIONS</h1>
          <div className={`${style.social_handles}`}>
            <div className={`${style.social_handles_div_1}`}>
              <div className={style.social_media_popular}>
                <h4>S:</h4>
                <div className={style.social_media_popular_links}>
                ...
                <div className={style.email}>
                  <h4 className="mb-4">E:</h4>
                  <Link href="#" className="text-[1vw] mt-8">
                    k9vXy@example.com
                  </Link>
                </div>
              </div>
            </div>
            <div className={`${style.social_handles_div_2}`}>
              <div className={style.inner_handles}>
                <div className={style.more}>
                  <h4>M:</h4>
                  <div className={style.more_links}>
                    <Link href="#">Home</Link>
        ...
        <div className={style.footer_header_inner_element}>
          <h4 className="text-[#B4B4B4] text-[1.2vw]">
            © ochi design 2024. Legal Terms
          </h4>

          <h4 className="text-[#B4B4B4] text-[1.2vw] mr-16">Design by Ochi</h4>
        </div>
      </div>
    </div>
  );
